        ...
        <div id = 'main_body'>
            ...
            <article>
                <div class = "item1">
                    <div class = "row">
                        <div class = "column left">
                            <img src = "https://www.supercars.net/blog/wp-content/uploads/2018/06/Ferrari-LaFerrari-Ultimate-Guide-57.jpg" alt = "Car Rent Page" class = "rentPageImage"/>
                        </div>
                        ...
                        <h2>${carInventory[2].price}</h2>
                            <button class = "button" onClick = {handleClickR1}><img src = {rent_larger} alt ="buy now image1"/></button>
                        </div>
                    </div>
                </div>
                <br/>
                <div class = "item2">
                    <div class = "row">
                        <div class = "column left">
                            <img src = "https://thumbor.forbes.com/thumbor/fit-in/960x/https://www.forbes.com/wheels/wp-content/uploads/2022/07/2022_MB_G-Class_inline-1.jpg" alt = "Car Rent Page" class = "rentPageImage"/>
                        </div>
                        <div class = "column middle">
                        ...
                        <h2>${carInventory[3].price}</h2>
                            <button class = "button" onClick = {handleClickR2}><img src = {rent_larger} alt ="buy now image1"/></button>
                        </div>
                    </div>
                </div>
            </article>
