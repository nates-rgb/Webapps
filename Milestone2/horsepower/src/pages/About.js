...
export function About() {
    return (
        ...
        <div id = 'main_body'>
            ...
            <article>
        <img src = {aboutUs} alt = "About Us Title" className = "aboutUsHeader"/>
        ...
        <img src = {locationBanner} alt = "Location Title" className = "aboutUsHeader"/>
        <div className = "aboutUs">
            <br/>
            <iframe className="framed" title='google'
